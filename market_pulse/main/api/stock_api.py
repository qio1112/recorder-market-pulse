...
from main.tasks.update_stock_data import (
    update_stock_data,
    get_default_option_symbols_from_file,
    get_default_stock_symbols_from_file,
)
...
@router.post("/current-minute-prices")
...
@router.post("/stock-daily-history")
